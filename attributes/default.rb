...
default[:grinder][:user] = 'grinder'
default[:grinder][:group] = 'grinder'
default[:grinder][:version] = '3.11'
default[:grinder][:file] = "grinder-#{node[:grinder][:version]}-binary.zip"
default[:grinder][:url] = "http://downloads.sourceforge.net/project/grinder/The%20Grinder%203/#{node[:grinder][:version]}/#{node[:grinder][:file]}"
...
default[:grinder][:properties]['processIncrementInterval'] = 60_000
default[:grinder][:properties]['initialProcesses'] = 1
default[:grinder][:properties]['duration'] = 60_000
...
default[:grinder][:properties]['jvm.classpath'] = ''
default[:grinder][:properties]['jvm.arguments'] = ''
default[:grinder][:properties]['logDirectory'] = "#{node[:grinder][:working_dir]}/log"
default[:grinder][:properties]['hostID'] = node[:hostname]
default[:grinder][:properties]['consoleHost'] = '127.0.0.1'
